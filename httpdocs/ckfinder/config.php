<?php
/*
 * ### CKFinder 4.3.1 : Configuration File - Basic Instructions
 *
...
*/
#$baseUrl = 'http://stonehenge/archersprep/ckfinder/userfiles/';
//$baseUrl = 'http://navigatormultimedia.com/serpentaquatics/ckfinder/userfiles/';
$page = pathinfo($_SERVER['PHP_SELF']);
$folders = explode("/", $page['dirname']);
if($folders[1] != "ckfinder") $vdomain = $folders[1]."/";
if(substr($vdomain, 0, 1) != "/") $vdomain = "/".$vdomain;
$baseUrl = "http://".$_SERVER['HTTP_HOST'].$vdomain."ckfinder/userfiles/";
...
ATTENTION: The trailing slash is required.
*/
#$baseDir = "/var/www/vhosts/navigatormultimedia.com/httpdocs/okmapguides/ckfinder/userfiles/";
#$baseDir = resolveUrl($baseUrl);
