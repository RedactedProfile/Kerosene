...
class admin extends BaseAdmin {
	...
	public function cart() {
		...
		switch($this->uri->arguments[0]) {
			...
			default:
				redirect("/admin/cart/products");
				break;
			case "products":
				load::view("admin/header", $this->data);
				load::view("admin/list.cart.products", $this->data);
				load::view("admin/footer", $this->data);
				break;
			case "receipts":
				load::view("admin/header", $this->data);
				load::view("admin/list.cart.receipts", $this->data);
				load::view("admin/footer", $this->data);
				break;
			case "settings":
				load::view("admin/header", $this->data);
				load::view("admin/settings.cart", $this->data);
				load::view("admin/footer", $this->data);
				break;
