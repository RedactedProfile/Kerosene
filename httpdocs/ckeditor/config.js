...
CKEDITOR.editorConfig = function( config ) {
    ...
    if(host == 'stonehenge' || host == 'badger' || host == 'navigatormultimedia.com' || host == 'www.navigatormultimedia.com' || host == 'localhost'){
    ...
    config.toolbar = 'CustomWithSource';
    config.width = '750px';
    config.resize_maxWidth = 750;
    config.resize_minWidth = 750;
    config.resize_maxHeight = 520;
    config.startupFocus = true;
    config.contentsCss = dir+'/css/master.css';
